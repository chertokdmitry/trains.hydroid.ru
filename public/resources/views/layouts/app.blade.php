    ...
    <header style="margin-bottom:50px;">
        <div class="inner">
            ...
            <nav class="nav nav-masthead justify-content-center">
                <a class="nav-link {{ $navStatus[0] }}" href="/">Главная</a>
                <!-- Authentication Links -->
                <a  class="nav-link {{ $navStatus[1] }}"  href="/add">Новый маршрут</a>
                <a  class="nav-link {{ $navStatus[2] }}"  href="/couriers">Курьеры</a>
                <a  class="nav-link {{ $navStatus[3] }}"  href="/regions">Города</a>
                <a  class="nav-link {{ $navStatus[4] }}"  href="/schedule">Расписание</a>
            </nav>
        </div>
    </header>
